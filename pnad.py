# -*- coding: utf-8; -*-
# pnad.py - Extract & analyze basic data from pnad
#
# Copyright (C) 2015-2017  Lincoln Clarete <lincoln@clarete.li>
#
...
CLASSES_TABLE = {
    'Ate 1SM':       [('lt',  622)],
    'De 1 a 2 SM':   [('gte', 622), ('lt', 1244)],
    'De 2 a 3SM':    [('gte', 1244), ('lt', 1866)],
    'De 3 a 5SM':    [('gte', 1866), ('lt', 3110)],
    'De 5 a 10SM':   [('gte', 3110), ('lt', 6220)],
    'De 10 a 20SM':  [('gte', 6220), ('lt', 12440)],
    'Acima de 20SM': [('gte', 12440)],
}
